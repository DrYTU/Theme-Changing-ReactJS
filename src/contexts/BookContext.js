...
// - Default Value Verdik ve Export ettik
// - Kullanmak istediğimiz yerde context'i import ettik.
// - ContextType yardımıyla contexti ilgili component'a atadık
// - this.context ile de verileri aldık.


//  2-) Provide --> Consumer
// - Context Dosyasında bir class component oluşturup veriyi state içine koy
// - Sonra Context.Provider etiketlerine value olarak this.state vererek Context'e ait Provider ile veriyi al
// - Provider etiketlerinin içine {this.props.children diyerek çocuk elemanlara gönder}
// - App.js'de Context etiketlerinin içine comsume yapılacak componenti child olarak ver
// - Consumer olacak componentin içinde Contexti import et
// - Render içince consumemr ile provider'dan gelen veriyi yakala
